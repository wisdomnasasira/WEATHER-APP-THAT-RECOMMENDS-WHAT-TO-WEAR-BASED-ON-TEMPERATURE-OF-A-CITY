function getweather() {
    const apikey = '690e326c947c1e37bd05158fcdd6c5a4';
...
function displayWeather(data) {
    ...
    const clothingRecommendationDiv = document.getElementById('clothing-recommendation');
    ...
    if (data.cod === '404') {
        ...
        clothingRecommendationDiv.innerHTML = `<p>${clothingRecommendation}</p>`;
